...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <h2>今年已经休假<% out.print(request.getAttribute("total")); %>天</h2>
