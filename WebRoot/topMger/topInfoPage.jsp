...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <h2>公司全部员工今年已经休假<% out.print(request.getAttribute("total")); %>天</h2>
        ...
        <div class="col-lg-4">
            ...
            <h2>当年公司全员共加班<% out.print(request.getAttribute("overtime")); %>天</h2>
        </div>
        <div class="col-lg-4">
            <img class="img-circle" src="/img/details.png" alt="Generic placeholder image" style="width: 140px; height: 140px;">
            <h2>详细记录</h2>
            <p>筛选各种请假、加班记录</p>
            <p><a class="btn btn-default" href="/topMger/leaveRules" role="button">选择筛选条件 &raquo;</a></p>
        </div>
    </div>
