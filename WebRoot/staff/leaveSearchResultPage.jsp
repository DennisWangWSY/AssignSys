...
<!DOCTYPE html>
    ...
    #nav{ margin:0 auto; width:400px; height:100px;}
        ...
        <%
    		List<Askforleavesheet> list= (List<Askforleavesheet>) request.getAttribute("list");
    		if(!list.isEmpty()){%>
    ...
    <thead>
        ...
        <tbody><%
            	Iterator<Askforleavesheet> iter=list.iterator();
        		while(iter.hasNext()){%>
            <tr class=" <%
            		Askforleavesheet re = iter.next();
